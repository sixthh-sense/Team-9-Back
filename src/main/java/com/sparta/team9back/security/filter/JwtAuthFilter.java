...
import com.sparta.team9back.security.jwt.HeaderTokenExtractor;
import com.sparta.team9back.security.jwt.JwtPreProcessingToken;
...
public class JwtAuthFilter extends AbstractAuthenticationProcessingFilter {
    ...
    //헤더에서 토큰 추출(HeaderTokenExtractor 클라스)
    ...
    public Authentication attemptAuthentication(
        ...
        //토큰이 있다면 JWT 추출해서 토큰생성 (JwtPreProcessingToken 클라스)
        JwtPreProcessingToken jwtToken = new JwtPreProcessingToken(
                extractor.extract(tokenPayload, request));
        //2. JWTAuthProvider 호출(JWT 유효성 검사)
        return super
